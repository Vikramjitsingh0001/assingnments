...
conn.execute("INSERT INTO COMPANY (ID,NAME,AGE,ADDRESS,SALARY) VALUES(1,'TIGER',61,'GYMKHANA',20000.00)")
conn.execute("INSERT INTO COMPANY (ID,NAME,AGE,ADDRESS,SALARY) VALUES(2,'ZINDA_HA',29,'GYMKHANA',210000.00)")
conn.commit()
...
conn.execute("UPDATE COMPANY set SALARY = SALARY + 10000 where AGE=27")
cusor=conn.execute("SELECT id,name,address,salary from company")
